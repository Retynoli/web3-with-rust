...
contract OKOKUStaking is Ownable, ERC721Holder, Pausable {

    using EnumerableSet for EnumerableSet.UintSet;
    IERC721 public nftContractInstance;
    IERC20 public tokenContractInstance;

    // Number of tokens per block. There are approx 6k blocks per day and 2 tokens are represented by 10**18 (after considering decimals).
    uint256 public rate;
    ...
    function claimRewards(uint256[] calldata tokenIds) public whenNotPaused {
		...
		totalEarn[msg.sender] = totalEarn[msg.sender] + reward;
    }
